...
const demoListings: Listing[] = [
  {
    ...
    image_urls: ['/hero-bg.png', '/hero-background.png', '/realtor.png'],
    status: 'active',
    agent_id: 'demo-agent',
  ...
  },
  {
    ...
    image_urls: ['/circuit-brain.png', '/circuit-lines.png', '/hero-bg.png'],
    status: 'active',
    agent_id: 'demo-agent',
  ...
  },
  {
    ...
    image_urls: ['/headshot (1).png', '/realtor.png', '/hero-background.png'],
    status: 'draft',
    agent_id: 'demo-agent',
