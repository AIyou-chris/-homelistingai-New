...
import { MapPinIcon, CurrencyDollarIcon, HomeIcon, ArrowsPointingOutIcon, PencilSquareIcon, DocumentTextIcon, RocketLaunchIcon } from '@heroicons/react/24/outline';
    ...
    <div className="bg-slate-800 rounded-lg shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-sky-500/30 transform hover:-translate-y-1">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-3 border-t border-slate-700">
          {isDemoMode ? (
            // Demo mode with all action buttons
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button 
                variant="danger" 
                size="sm" 
                className="w-full bg-red-700/50 hover:bg-red-600"
