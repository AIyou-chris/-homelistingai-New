...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-background shadow-lg fixed w-full z-50 border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2">
              <img src="/homelistingai-logo.png" alt="HomeListingAI Logo" className="h-10 w-auto" />
              <span className="hidden sm:inline text-2xl font-bold text-primary">HomeListingAI</span>
            </Link>
          </div>
